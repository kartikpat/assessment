...
class AssessmentTestCase(unittest.TestCase):
    """This class represents the assessment test case"""
    ...
    def test_assessment_creation(self):
        """Test API can create a assessment (POST request)"""
        res = self.client().post('/assessment', data=self.assessment)
        self.assertEqual(res.status_code, 200)
        self.assertIn('success', str(res.data))

    # def test_api_can_get_all_assessment(self):
    ...
    # def test_api_can_get_assessment_by_id(self):
